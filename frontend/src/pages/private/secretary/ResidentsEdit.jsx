                ...
                <ScrollArea className="max-h-[80vh] w-full pr-2">
                    <Form onSubmit={handleSubmit} className="max-w-3xl mx-auto flex flex-col gap-8 p-4">
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <FormInput label="Father's Name" name="fatherName" value={resident.parents?.father?.name || ''} onChange={e => handleParentChange('father', 'name', e.target.value)} required />
                                <FormInput label="Father's Occupation" name="fatherOccupation" value={resident.parents?.father?.occupation || ''} onChange={e => handleParentChange('father', 'occupation', e.target.value)} required />
                                <FormInput label="Father's Contact" name="fatherContactNumber" value={resident.parents?.father?.contactNumber || ''} onChange={e => handleParentChange('father', 'contactNumber', e.target.value)} required />
                                <FormInput label="Mother's Name" name="motherName" value={resident.parents?.mother?.name || ''} onChange={e => handleParentChange('mother', 'name', e.target.value)} required />
                                <FormInput label="Mother's Occupation" name="motherOccupation" value={resident.parents?.mother?.occupation || ''} onChange={e => handleParentChange('mother', 'occupation', e.target.value)} required />
                                <FormInput label="Mother's Contact" name="motherContactNumber" value={resident.parents?.mother?.contactNumber || ''} onChange={e => handleParentChange('mother', 'contactNumber', e.target.value)} required />
                            </div>
                        </section>
                        <div className="flex justify-end gap-2 mt-4">
